...
public class PeripheralController {
    ...
    public List<Peripheral> getByPrice(@PathVariable("price") double price){
        return accesoryService.getByPrice(price);
    }
    
    @GetMapping("/description/{description}")
    public List<Peripheral> getByDescriptionContainingIgnoreCase(@PathVariable("description") String description){
        return accesoryService.getByDescriptionContainingIgnoreCase(description);
    }
